...
#define STATUS_STATE_GAME 1#include <SDL2/SDL.h>
#include <SDL2/SDL_image.h>
#include <SDL2/SDL_ttf.h>
#include <stdio.h>
#include <stdlib.h>
...
void draw_status_lives(GameState* game) {
	...
	SDL_RenderClear(game->renderer);
  	...
  	SDL_Rect textRect = {320, 240-game->label2H, game->label2W, game->label2H};
  	SDL_RenderCopy(game->renderer, game->label2, NULL, &textRect);*/
